...
把字幕全文、视频基本信息、搜同类热门视频、再给我站内热门榜单前 10
```
...
Give me full subtitles, video metadata, search similar hot videos, and site-wide hot ranking top 10
```
...
*(Add screenshots here after real run — e.g., subtitle extraction output, search results, hot ranking table)*
